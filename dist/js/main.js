...
$(function(){
    ...
    var filterLinks = $('#filter a');
    // init
    $container.imagesLoaded( function() {
        var initFilterLink = $('#filter').find('a[data-filter=".publication"]');
        initFilterLink.addClass('selected-filter');
        $container.isotope({ 
            itemSelector: ".item",
            masonry: {
    ...
    function updateFilter() {
        ...
        var selector = filterElement.attr('data-filter');
        filterLinks.removeClass('selected-filter');
        filterElement.addClass('selected-filter');
        $container.isotope({filter: selector});
        return false;
    }

    // filter items when filter link is clicked
    filterLinks.click(updateFilter);
});
...
function goToPortfolio(dataFilter) {
    var filterLinks = $('#filter a');
    var $container = $('.isotope');
    var filterElement = $('#filter').find('a[data-filter="' + dataFilter + '"]');
    var selector = filterElement.attr('data-filter');
    filterLinks.removeClass('selected-filter');
    filterElement.addClass('selected-filter');
    $container.isotope({filter: selector});
